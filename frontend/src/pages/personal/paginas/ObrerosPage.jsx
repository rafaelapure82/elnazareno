            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="mb-8">
                    <div className="flex items-center mb-4">
                        <FaHardHat className="h-8 w-8 text-orange-600 mr-3" />
                        <div>
                            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">
                                Gestión de Personal Obrero
                            </h1>
                            <p className="text-gray-600 mt-1">
                                Administra el registro de personal obrero
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
                        <div className="bg-white rounded-lg border border-gray-200 p-4">
                            <div className="flex items-center justify-between">
                                <div>
                                    ...
                                    <div className="text-sm text-gray-600">Total Obreros</div>
                                </div>
                                <FaHardHat className="h-8 w-8 text-orange-400" />
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-4">
                            <div className="flex items-center justify-between">
                                ...
                                <FaHardHat className="h-8 w-8 text-blue-400" />
                            </div>
                        </div>
                        ...
                        <div className="bg-white rounded-lg border border-gray-200 p-4">
                            <div className="flex items-center justify-between">
                                ...
                                <FaHardHat className="h-8 w-8 text-pink-400" />
                            </div>
                        </div>
